...
(Full paper publication) [Oh, Y., Lim, C., Lee, J., Kim, S., & Kim, S. (2024). Multichannel convolution neural network for gas mixture classification. Annals of Operations Research, 339(1-2), 261-295.](https://link.springer.com/article/10.1007/s10479-022-04715-2)
...
@article{oh2024multichannel,
  ...
  url       = {https://link.springer.com/10.1007/s10479-022-04715-2}
}
```
